...
<!-- QUESTIONS RELATED -->
<?php elseif (is_category(28) || parent_category_is(28)) : ?>
...
<?php elseif (parent_category_is(25)) : ?>
    ...
    <?php do_action('bp_before_archive') ?>
            ...
            <div class="page" id="blog-archives">
                <h1>Resources Related to Journalism and <?php wp_title(null); ?> <span class="feed"><a href="/?cat=<?php echo get_query_var('cat'); ?>&amp;feed=rss2"><img src="/feed.png" alt="Feed Icon" /></a> <a href="/?cat=<?php echo get_query_var('cat'); ?>&amp;feed=rss2">Feed for this topic</a></span></h1><h3 class="index_title"><a href="/resource-index/" class="resource"><span class="expandlink">Resources Index</span></a></h3>
    <?php echo category_description(); ?>
