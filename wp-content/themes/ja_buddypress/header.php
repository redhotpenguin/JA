...
<link rel="stylesheet" href="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/wp-content/themes/ja_buddypress/lightbox.css" type="text/css" media="screen" />
 -->
	...
	<script type="text/javascript" src="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/js/fancybox/jquery.fancybox.js?v=2.1.0"></script>
	<link rel="stylesheet" type="text/css" href="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/js/fancybox/jquery.fancybox.css?v=2.1.0" media="screen" />

	<!-- Add Button helper (this is optional) -->
	<link rel="stylesheet" type="text/css" href="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/js/fancybox/helpers/jquery.fancybox-buttons.css?v=1.0.3" />
	<script type="text/javascript" src="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/js/fancybox/helpers/jquery.fancybox-buttons.js?v=1.0.3"></script>

	<!-- Add Thumbnail helper (this is optional) -->
	<link rel="stylesheet" type="text/css" href="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/js/fancybox/helpers/jquery.fancybox-thumbs.css?v=1.0.6" />
	<script type="text/javascript" src="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/js/fancybox/helpers/jquery.fancybox-thumbs.js?v=1.0.6"></script>

	<!-- Add Media helper (this is optional) -->
	<script type="text/javascript" src="<?php $bloginfo = get_bloginfo( 'wpurl' ); ?>/js/fancybox/helpers/jquery.fancybox-media.js?v=1.0.3"></script>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=386205134778092";
