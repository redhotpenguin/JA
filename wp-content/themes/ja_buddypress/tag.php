<?php get_header(); ?>
	...
	<div id="content">
		...
		<div class="page" id="blog-archives">
			...
			<h1>Posts about <?php wp_title(null); ?> <span class="feed"><a href="/?cat=<?php echo get_query_var('cat'); ?>&amp;feed=rss2"><img src="/feed.png" alt="Feed Icon" /></a> <a href="/?cat=<?php echo get_query_var('cat'); ?>&amp;feed=rss2">Feed for this tag</a></span></h1>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while (have_posts()) : the_post(); global $post; ?>
					...
					<div class="post" id="post-<?php the_ID(); ?>">
						...
						<?php $category = get_the_category(); $cat_number = count($category); if ($cat_number > 1) { ?>
						Topics:<?php } else { ?>Topic:<?php } ?> <?php the_category(', ') ?> Tags: <?php the_tags('',', ',''); ?>
						</p>
