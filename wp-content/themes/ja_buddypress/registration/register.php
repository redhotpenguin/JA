	...
	<div id="content">
		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<h2><?php _e( 'Create a Profile', 'buddypress' ) ?></h2>
				...
				<?php if ( bp_is_active( 'xprofile' ) ) : ?>
					...
					<div class="register-section" id="profile-details-section">
						...
						<h4><?php _e( 'Profile', 'buddypress' ) ?></h4>
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_registration_needs_activation() ) : ?>
					<p class="needs-activation"><?php 
					 
					 // heredoc syntax allows to have a string variable on multilines without breaking the code. It also avoids appending strings.
					 $success_msg = <<< EOT
					<p>
You have successfully created your account. 
Please log in using the username and password you have just created.</p>

<p>
<strong>Have you checked out the forum?</strong>
<a href="http://www.journalismaccelerator.com/topics/questions/">Browse through questions</a> posted by the Journalism Accelerator community or ask a question for discussion.
</p>

<p>
<strong>Looking for a resource?</strong>
Check out our archive of <a href="http://www.journalismaccelerator.com/topics/resources/">resource listings</a> or suggest a resource to the JA team.
</p>

<p>
<strong>Have you visited our blog?</strong>
<a href="http://www.journalismaccelerator.com/topics/blog/">Read through blog posts</a> by the Journalism Accelerator and guest contributors.
</p>.
EOT;
					 
					_e( $success_msg, 'buddypress' );
					?></p>
