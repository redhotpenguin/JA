...
function bp_core_add_settings_nav() {
	...
	'name' => __( 'Comment Subscriptions', 'buddypress' ), 
	'slug' => 'comment-subscriptions', 
	'parent_url' => '/', 
	'parent_slug' => $bp->settings->slug, 
	'screen_function' =>  'custom_manage_subscriptions',
	'bp_core_screen_geeneral_settings', 
	'position' => 80, 
...
function bp_core_screen_general_settings() {
	...
	add_action( 'bp_template_content', 'custom_bp_core_screen_general_settings_content' );

	bp_core_load_template( apply_filters( 'bp_core_template_plugin', 'members/single/plugins' ) );
}

function custom_bp_core_screen_general_settings_content(){
	$current_user = wp_get_current_user();
	 $provider = get_user_meta($current_user->ID, 'rpx_provider', true); 
	?>
	<div class='connect_settings'>
	<p>You connected to the Journalism Accelerator using <span class='settings_provider'><?php echo $provider;?></span>. 
	<br/>If you would like to change the social media site which you used to 
	connect, please contact <a href ="mailto:kelsey@journalismaccelerator.com">Kelsey</a>.</p>
	</div>
	<?php
}
