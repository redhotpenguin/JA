...
?>
	...
	<table class="form-table">
		...
		<tr>
			...
			<td><input type="text" name="#username" id="username" size="75" maxlength="75" value="<?php echo $options['username']; ?>" /></td>
		</tr>
		<tr>
			...
			<td><input type="password" name="#password" id="password" size="75" maxlength="75" value="<?php echo $options['password']; ?>" /></td>
		</tr>
		<tr>
