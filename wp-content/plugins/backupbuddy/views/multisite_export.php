...
global $wpdb;
if ( substr_count( $wpdb->prefix, '_' ) == '1' ) {
	echo '<h3>' . __( 'Export Unavailable for Main Site', 'it-l10n-backupbuddy' ) . '</h3>';
	_e( 'The main Network site cannot be exported as it is tied to the Network. It can only be backed up from the main Network Admin. All other subsites can be exported for importing into the same Network (aka Duplicate), another Network, or as a standalone site.', 'it-l10n-backupbuddy' );
