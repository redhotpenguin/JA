...
define('RPX_VEMAIL_OPTION_DEFAULT',        true);
...
define('RPX_AUTOREG_OPTION_DEFAULT',       true);
...
define('RPX_HELP_MENU_LABEL',              'Help');
...
define('RPX_TOKEN_URL',                    str_replace('./','/',site_url()) . '/?action='.RPX_TOKEN_ACTION);//Strip trailing dot. (dot terminated FQDN is currently unsupported)
...
$rpx_http_vars['redirect_to']    =  $_SERVER["REQUEST_URI"];
...
$rpx_advanced['RPX_VERBOSE']            = array('default' => 'true', 'desc' => 'Set this to true to get errors and actions sent to the default PHP error log.');
...
$rpx_advanced['RPX_SERIAL_PROFILE']     = array('default' => 'true', 'desc' => 'Set to true to store the full profile in a serialized usermeta each signon (RPX_META_PROFILE).');
$rpx_advanced['RPX_AUTH_INFO_EXTENDED'] = array('default' => 'true', 'desc' => 'PLUS/PRO/ENT Set to true to return auth_info extended this data could be used by other plugins or custom themes.');
$rpx_advanced['RPX_SERIAL_CONTACTS']    = array('default' => 'true', 'desc' => 'PLUS/PRO/ENT Set to true to store the get_contacts in a serialized usermeta (RPX_META_CONTACTS) each time it succeeds.');
$rpx_advanced['RPX_GET_CONTACTS']       = array('default' => 'true', 'desc' => 'PLUS/PRO/ENT (not for production use) Set to true to collect the get_contacts data each sign on. This is slow.(populates $rpx_contacts global)');
