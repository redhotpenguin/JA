...
if ( !in_array($action, array('logout', 'mustactivate', 'lostpassword', 'retrievepassword', 'resetpass', 'rp', 'register', 'login'), true) && false === has_filter('login_form_' . $action) )
	$action = 'login';
...
case 'mustactivate' :
	...
	?>
	<div id="login_error">
		<?php _e('Your account has not been activated yet.  Please check the email address you used to create your account and click on the activation link.') ?></div>
